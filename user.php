                                                    ...
                                                    echo'
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <button type="button" onclick="modUser(id_user_'.$i.'.value);" class="btn btn-warning btn-sm" data-original-title="Editar" data-toggle="modal" data-target="#user-mod"><i class="fa fa-pencil"></i></button>                                                                
                                                                <a href="query/action.php?id_user='.$tab_user[$i]['id'].'" class="btn btn-danger btn-sm" data-toggle="tooltip" data-original-title="Eliminiar"> <i class="fa fa-trash"></i> </a>
                                                                <a href="query/action.php?id_user_activer='.$tab_user[$i]['id'].'" class="btn btn-success btn-sm" data-toggle="tooltip" data-original-title="Activar"> <i class="fa fa-check"></i> </a>
                                                                <a href="query/action.php?id_user_desactiver='.$tab_user[$i]['id'].'" class="btn btn-inverse btn-sm" data-toggle="tooltip" data-original-title="Desactivar"> <i class="fa fa-close"></i> </a>
                                                            </td>
                                                        </tr>
                                                    ';
                                                }
