                                            ...
                                            <?php
                                                for($i=0; $i<count($tab_requete); $i++){
                                                    ...
                                                    echo'
                                                        <tr>
                                                            <td>'.($i+1).'</td>
                                                            <td><span class="'; if($tab_requete[$i]['statut_paiement']=='yes'){echo 'badge badge-success'; $statut_pay='Pagado';}else{echo 'badge badge-warning'; $statut_pay='No Pagado';} echo '">'.$statut_pay.'</span></td>
