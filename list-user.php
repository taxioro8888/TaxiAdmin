            ...
            <div class="container-fluid">
                                            ...
                                            for ($i = 0; $i < count($tab_user_app); $i++) {
                                                ...
                                                echo '">' . $tab_user_app[$i]['statut'] . '</span></td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="query/action.php?id_user_app_activer=' . $tab_user_app[$i]['id'] . '" class="btn btn-success btn-sm" data-toggle="tooltip" data-original-title="habilitar"> <i class="fa fa-check"></i> </a>
                                                                <a href="query/action.php?id_user_app_desactiver=' . $tab_user_app[$i]['id'] . '" class="btn btn-inverse btn-sm" data-toggle="tooltip" data-original-title="DesHabilitar"> <i class="fa fa-close"></i> </a>
                                                                 <a href="query/action.php?id_user_app=' . $tab_user_app[$i]['id'] . '" class="btn btn-danger btn-sm" data-toggle="tooltip" data-original-title="ELiminar"> <i class="fa fa-trash"></i> </a>
                ...
                <div class="right-sidebar">
                    <div class="slimscrollright">
                        <div class="rpanel-title"> Ajustes color <span><i class="ti-close right-side-toggle"></i></span> </div>
                        <div class="r-panel-body">
                            <ul id="themecolors" class="m-t-20">
                                <li><b>barra lateral</b></li>
                                ...
                                <li class="d-block m-t-30"><b>barra lateral oscuro</b></li>
                            ...
                            <ul class="m-t-20 chatonline">
                                <li><b>Opciones de chat</b></li>
                                <li>
                                    <a href="javascript:void(0)"><img src="assets/images/users/flag.png" alt="user-img" class="img-circle"> <span>admin <small class="text-success">en linea</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="assets/images/users/flag.png" alt="user-img" class="img-circle"> <span>atencion cliente <small class="text-warning">en linea</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="assets/images/users/flag.png" alt="user-img" class="img-circle"> <span>programador <small class="text-danger">Ocupado</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="assets/images/users/flag.png" alt="user-img" class="img-circle"> <span>analista <small class="text-muted">en linea</small></span></a>
                                </li>
