                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-dark btn-sm" data-toggle="modal" data-target="#add-payment-method"><i class="fa fa-plus m-r-10"></i>Agregar</button>
                                                ...
                                                for($i=0; $i<count($tab_payment_method); $i++){
                                                    echo'
                                                        ...
                                                        <input type="hidden" value="'.$tab_payment_method[$i]['id'].'" name="" id="id_method_'.$i.'">
                                                            <button type="button" onclick="modPaymentMethod(id_method_'.$i.'.value);" class="btn btn-warning btn-sm" data-original-title="Editar" data-toggle="modal" data-target="#payment-method-mod"><i class="fa fa-pencil"></i></button> 
                                                          
                                                            <a href="query/action.php?id_method_activer='.$tab_payment_method[$i]['id'].'" class="btn btn-success btn-sm" data-toggle="tooltip" data-original-title="Activar"> <i class="fa fa-check"></i> </a>
                                                            <a href="query/action.php?id_method_desactiver='.$tab_payment_method[$i]['id'].'" class="btn btn-inverse btn-sm" data-toggle="tooltip" data-original-title="Desactivar"> <i class="fa fa-close"></i> </a> 
                                                            </td>
                                                        </tr>
                                                    ';
                                                }
