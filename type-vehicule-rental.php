                                                    ...
                                                    echo'
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <button type="button" onclick="modTypeVehicule(id_type_vehicule_'.$i.'.value);" class="btn btn-warning btn-sm" data-original-title="Modificar" data-toggle="modal" data-target="#type-vehicule-mod"><i class="fa fa-pencil"></i></button>
                                                                <a href="query/action.php?id_type_vehicule_rental='.$tab_type_vehicule[$i]['id'].'" class="btn btn-danger btn-sm" data-toggle="tooltip" data-original-title="Eliminar"> <i class="fa fa-trash"></i> </a>
                                                            </td>
                                                        </tr>
                                                    ';
                                                }
