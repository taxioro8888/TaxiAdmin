                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-dark btn-sm" data-toggle="modal" data-target="#add-notification"><i class="fa fa-plus m-r-10"></i>Agregar</button>
                                                ...
                                                for($i=0; $i<count($tab_notification); $i++){
                                                    echo'
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="query/action.php?id_notification='.$tab_notification[$i]['id'].'" class="btn btn-danger btn-sm" data-toggle="tooltip" data-original-title="Eliminar"> <i class="fa fa-trash"></i> </a>
                                                            </td>
                                                        </tr>
                                                    ';
                                                }
