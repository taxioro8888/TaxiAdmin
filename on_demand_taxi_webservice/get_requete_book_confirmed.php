<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        r.heure_retour,r.statut_round,r.number_poeple,r.place,r.statut,r.id_conducteur,r.creer,r.trajet,u.nom,u.prenom,r.distance,u.phone,c.nom as nomConducteur,c.prenom as prenomConducteur,c.phone as driverPhone,
        r.montant,r.duree,r.statut_paiement,r.date_book,r.nb_day,r.heure_depart,r.cu,m.libelle as payment,m.image as payment_image
        FROM tj_requete_book r, tj_user_app u, tj_conducteur c, tj_payment_method m
        WHERE r.id_user_app=u.id AND r.id_payment_method=m.id AND r.id_conducteur=$id_driver AND r.statut='confirmed' AND r.id_conducteur=c.id
