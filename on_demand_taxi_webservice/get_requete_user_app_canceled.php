<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        c.photo_path,r.date_retour,r.montant,r.duree,r.statut_paiement,m.libelle as payment,m.image as payment_image
        ...
        while($row = mysqli_fetch_assoc($result)) {
            ...
            if($id_conducteur != 0){
                ...
                $sql_phone = "SELECT phone FROM tj_conducteur WHERE id=$id_conducteur";
