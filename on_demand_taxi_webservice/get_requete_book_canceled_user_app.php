<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        r.number_poeple,r.place,r.statut,r.id_conducteur,r.creer,r.trajet,u.nom,u.prenom,r.distance,u.phone,c.nom as nomConducteur,c.prenom as prenomConducteur,c.phone as driverPhone,
        r.heure_retour,r.statut_round,r.montant,r.duree,r.statut_paiement,r.date_book,r.nb_day,r.heure_depart,r.cu,m.libelle as payment,m.image as payment_image
        FROM tj_requete_book r, tj_user_app u, tj_conducteur c, tj_payment_method m
        WHERE r.id_user_app=u.id AND r.id_payment_method=m.id AND r.id_user_app=$id_user_app AND r.statut IN ('canceled','rejected') AND r.id_conducteur=c.id
        ORDER BY r.id DESC";
        ...
        while($row = mysqli_fetch_assoc($result)) {
            ...
            if($id_driver != 0){
                ...
                // Note conducteur
                $sql_note = "SELECT niveau FROM tj_note WHERE id_user_app=$id_user_app AND id_conducteur=$id_driver";
