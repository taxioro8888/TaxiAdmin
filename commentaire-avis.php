                                                            ...
                                                            echo'
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <button type="button" onclick="modAnnee(id_affectation_'.$i.'.value);" class="btn btn-warning btn-sm" data-original-title="Editar" data-toggle="modal" data-target="#annee-mod"><i class="fa fa-pencil"></i></button>
                                                                        ...
                                                                        <a href="query/action.php?id_affectation_activer='.$tab_commentaire[$i]['id'].'" class="btn btn-success btn-sm" data-toggle="tooltip" data-original-title="Activar"> <i class="fa fa-check"></i> </a>
                                                                        <a href="query/action.php?id_affectation_desactiver='.$tab_commentaire[$i]['id'].'" class="btn btn-inverse btn-sm" data-toggle="tooltip" data-original-title="Des Activar"> <i class="fa fa-close"></i> </a>
                                                                    </td>
                                                                </tr>
                                                            ';
                                                        }
