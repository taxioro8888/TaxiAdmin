                                                    ...
                                                    echo'
                                                        <tr>
                                                            ...
                                                            <td>
                                                             ...
                                                             <a href="query/action.php?id_country_activer='.$tab_country[$i]['id'].'" class="btn btn-success btn-sm" data-toggle="tooltip" data-original-title="Activar"> <i class="fa fa-check"></i> </a>
                                                             <input type="hidden" value="'.$tab_country[$i]['id'].'" name="" id="id_currency_'.$i.'">
                                                             <button type="button" onclick="modCountry(id_currency_'.$i.'.value);" class="btn btn-warning btn-sm" data-original-title="Editar" data-toggle="modal" data-target="#country-mod"><i class="fa fa-pencil"></i></button>
