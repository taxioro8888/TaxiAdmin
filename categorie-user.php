                                                    ...
                                                    echo'
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <button type="button" onclick="modCategorieUser(id_categorie_user_'.$i.'.value);" class="btn btn-warning btn-sm" data-original-title="Modificar" data-toggle="modal" data-target="#categorie-user-mod"><i class="fa fa-pencil"></i></button>
                                                                <a href="query/action.php?id_categorie_user='.$tab_categorie_user[$i]['id'].'" class="btn btn-danger btn-sm" data-toggle="tooltip" data-original-title="Eliminar"> <i class="fa fa-trash"></i> </a>
                                                            </td>
                                                        </tr>
                                                    ';
                                                }
