                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><?php echo $list_of_drivers ?></h4>
                                 <!-- aqui agregamos -->
                               <button type="button" class="btn btn-dark btn-sm" data-toggle="modal" data-target="#add-conducteur"><i class="fa fa-plus m-r-10"></i>Agregar</button>
                                                    ...
                                                    echo'
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <button type="button" onclick="modConducteur(id_conducteur_'.$i.'.value);" class="btn btn-warning btn-sm" data-original-title="Editar" data-toggle="modal" data-target="#conducteur-mod"><i class="fa fa-pencil"></i></button>
                                                               
                                                                <a href="query/action.php?id_conducteur_desactiver='.$tab_conducteur[$i]['id'].'" class="btn btn-inverse btn-sm" data-toggle="tooltip" data-original-title="DesActivar"> <i class="fa fa-close"></i> </a>
                                                            </td>
                                                        </tr>
                                                    ';
                                                }
