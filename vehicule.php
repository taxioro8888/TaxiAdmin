                                            ...
                                            for ($i = 0; $i < count($tab_vehicule); $i++) {
                                                ...
                                                echo '">' . $tab_vehicule[$i]['statut'] . '</span></td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <button type="button" onclick="modVehicule(id_vehicule_' . $i . '.value);" class="btn btn-warning btn-sm" data-original-title="Editar" data-toggle="modal" data-target="#vehicule-mod"><i class="fa fa-pencil"></i></button>
                                                                <a href="query/action.php?id_vehicule_rental_activer=' . $tab_vehicule[$i]['id'] . '" class="btn btn-success btn-sm" data-toggle="tooltip" data-original-title="Activar"> <i class="fa fa-check"></i> </a>
                                                                <a href="query/action.php?id_vehicule_rental_desactiver=' . $tab_vehicule[$i]['id'] . '" class="btn btn-inverse btn-sm" data-toggle="tooltip" data-original-title="Desactivar"> <i class="fa fa-close"></i> </a>
