                                                ...
                                                for($i=0; $i<count($tab_location); $i++){
                                                    echo'
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="query/action.php?id_location='.$tab_location[$i]['id'].'" class="btn btn-danger btn-sm" data-toggle="tooltip" data-original-title="Eliminar"> <i class="fa fa-trash"></i> </a>
                                                                <a href="query/action.php?id_location_activer='.$tab_location[$i]['id'].'" class="btn btn-success btn-sm" data-toggle="tooltip" data-original-title="Acceptar"> <i class="fa fa-check"></i> </a>
                                                                <a href="query/action.php?id_location_desactiver='.$tab_location[$i]['id'].'" class="btn btn-inverse btn-sm" data-toggle="tooltip" data-original-title="Negar"> <i class="fa fa-close"></i> </a>
                                                                <a href="query/action.php?id_location_cloturer='.$tab_location[$i]['id'].'" class="btn btn-info btn-sm" data-toggle="tooltip" data-original-title="Suspender"> <i class="mdi mdi-alert"></i> </a>
                                                            </td>
                                                        </tr>
                                                    ';
                                                }
